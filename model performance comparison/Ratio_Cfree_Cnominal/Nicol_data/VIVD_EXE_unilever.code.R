...
VIVD.Che.list <- read.csv("VIVD.Che.para_unilever.csv")
...
End.\n')      
  ...
  write.csv(VIVD.Che.list, "VIVD.Che.sim.results_unilever_HepG2.csv")
...
End.\n')      
  ...
  write.csv(VIVD.Che.list, "VIVD.Che.sim.results_unilever_HepRG_.csv")
  file.remove(paste("MCSim/VIVD_dynamic_", i, ".in", sep=""))
  print(i)
...
End.\n')      
  ...
  write.csv(VIVD.Che.list, "VIVD.Che.sim.results_unilever_MCF7.csv")
  file.remove(paste("MCSim/VIVD_dynamic_", i, ".in", sep=""))
  print(i)
