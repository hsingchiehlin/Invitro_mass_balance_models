...
VIVD.Che.list <- read.csv("VIVD.Che.para.drug_sch.csv")
...
temp         = 19;     # culture temperature (degrees celsius)
Vmedium      = 2000;    # (microL)
Sysdiameter  = 15.6;    # (mm)
Vwell        = 3400;    # (microL), 1mm3 = 1microL
...
f_NL    = 0.04;  # fraction (v/v) neutral lipid 
f_NLrbc = 0.0017;  # ~        in red blood cells

f_NP    = 0.01;  # fraction (v/v) neutral phospholipid
f_NPrbc = 0.0029;  # ~        in red blood cells

f_IW    = 0.89;   # fration (v/v) intracellular water
...
write.csv(VIVD.Che.list, "VIVD.drug.sim.results.sch.csv")
